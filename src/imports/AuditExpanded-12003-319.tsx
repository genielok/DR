...
import svgPaths from "./svg-p0qz7rpd5h";
type Wrapper1Props = {
...
export default function AuditExpanded({ className }: { className?: string }) {
  return (
    <div className={className || "bg-[#2b2f3f] h-[383px] relative w-[498px]"} data-name="audit_expanded">
      ...
      <div className="absolute content-stretch flex flex-col gap-[4px] items-start left-0 top-[44px] w-[498px]" data-name="Expanded">
        <div className="content-stretch flex flex-col gap-[6px] items-start py-[6px] relative shrink-0 w-full" data-name="Level_1">
        ...
        <div className="bg-[#19202c] content-stretch flex flex-col gap-[6px] items-end justify-center py-[6px] relative shrink-0" data-name="Level_2">
        ...
        <div className="content-stretch flex flex-col gap-[6px] items-start py-[6px] relative shrink-0 w-full" data-name="Level_3">
          <div className="h-[45px] overflow-clip relative shrink-0 w-full">
