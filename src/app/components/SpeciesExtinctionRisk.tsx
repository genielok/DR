...
/** Get IUCN breakdown from campaign's speciesByStatus */
function getIucnBreakdown(campaign: Campaign) {
  if (campaign.speciesByStatus) {
...
export function ProjectList({
  ...
  return (
    ...
    >
      {/* Header Card */}
      <div
        className="bg-[#2b2f3f] content-stretch flex items-center h-[54px] overflow-clip px-[20px] py-[10px] shadow-[0px_10px_30px_0px_rgba(0,0,0,0.25)] shrink-0 w-full"
        data-name="Card Menu"
      >
...
export { ProjectList as SpeciesExtinctionRiskContent };